    ...
    <div className={s.pageContainer}>
      <div className={s.innerContainer}>
        ...
        <form onSubmit={handleSubmit} className={s.formContainer}>
          ...
          {/* Two‑column layout: Property Details + Pricing & Location */}
            ...
            <div className={s.amenitiesGrid}>
              {commonAmenities.map((amenity) => {
                ...
                return (
                  <label
                    key={amenity}
                    className={isActive ? s.amenityLabelActive : s.amenityLabel}
                  >
                    <input
                      type="checkbox"
                      checked={isActive}
                    ...
                    />
                    <span className={isActive ? s.amenityTextActive : s.amenityText}>
                      {amenity}
                    </span>
                  </label>
                );
