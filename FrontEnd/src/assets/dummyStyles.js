...
//     statsGrid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12",
...
//     secondGrid: "grid grid-cols-1 md:grid-cols-2 gap-8 mb-8",
...
export const landingPageStyles = {
    ...
    badge: "badge bg-primary-light text-primary-dark mb-6 inline-block uppercase tracking-wider text-sm font-bold", // uppercase
    heroTitle: "hero-title text-[clamp(2rem,5vw,4.5rem)] mb-6 leading-[1.1] max-lg:text-[clamp(1.75rem,8vw,2.5rem)] max-lg:leading-tight max-lg:text-center",
    textGradient: "text-gradient",
    herosubtitle: "hero-subtitle text-[1.125rem] text-[#6b7280] mb-12 max-w-[540px] max-lg:text-base max-lg:mb-10 max-lg:mx-auto max-lg:text-center max-lg:px-4",
    ...
    categoryCard: "category-card py-10 px-6 text-center cursor-pointer bg-white rounded-3xl border border-[#e2e8f0] transition-all duration-300 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] hover:-translate-y-2 hover:border-primary hover:shadow-[0_12px_25px_-5px_rgba(13,148,136,0.1)] group max-sm:py-6 max-sm:px-4",
    categoryIconWrapper: "category-icon-wrapper w-16 h-16 bg-primary-light text-primary rounded-[1.25rem] flex items-center justify-center mx-auto mb-6 transition-all duration-300 group-hover:bg-primary group-hover:text-white group-hover:scale-110 max-sm:w-12 max-sm:h-12 max-sm:mb-4 max-sm:rounded-2xl",
    categoryName: "mb-2 text-xl font-bold max-sm:text-base",
    categoryCount: "text-text-muted text-[0.875rem]",

    // Features section
    featuresSection: "py-32",
    featuresContainer: "container features-container flex gap-24 items-center max-lg:flex-col max-lg:gap-12",
    featuresList: "features-list-container flex-1 grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-8 max-md:grid-cols-1 max-md:gap-8",
    featureCard: "fade-in feature-card-item p-8 bg-white rounded-3xl border border-[#e2e8f0] transition-all duration-300 flex flex-col items-start hover:border-primary hover:-translate-y-[5px] hover:shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05)]",
    featureIconWrapper: "w-14 h-14 bg-primary-light text-primary rounded-2xl flex items-center justify-center mb-6",
    ...
    learnMoreLink: "inline-block mt-12 text-primary font-semibold border-b-2 hover:text-primary-dark",

    // How It Works section
    // ---- Process (exactly like second image) ----
    processSection: "py-32 bg-white",
    processHeader: "text-center mb-20",
    processBadge: "badge bg-primary/10 text-primary mb-4 inline-block uppercase tracking-wider",
    processTitle: "text-5xl mb-6 max-sm:text-4xl text-[#111827] font-extrabold",
    processSubtitle: "text-[#6b7280] max-w-[600px] mx-auto text-lg",
    stepsGrid: "grid grid-cols-1 md:grid-cols-3 gap-12 max-md:gap-14",
    processCard: "py-12 px-8 bg-white/40 backdrop-blur-md rounded-[2rem] border border-white/50 relative transition-all duration-300 text-center hover:-translate-y-2 hover:bg-white hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] hover:border-primary-light",
    stepNumber: "absolute -top-6 left-1/2 -translate-x-1/2 w-16 h-16 bg-primary text-white rounded-[1.5rem] flex items-center justify-center text-2xl font-extrabold shadow-[0_8px_20px_rgba(13,148,136,0.3)]",
    processIconWrapper: "w-20 h-20 bg-primary-light text-primary rounded-[2rem] flex items-center justify-center mx-auto mt-4 mb-8",
    processCardTitle: "text-[1.5rem] mb-4 font-bold",
    processCardDesc: "text-[#6b7280] leading-[1.7]",
    ...
    loader: "loader w-10 h-10 border-4 border-solid border-secondary border-t-primary rounded-full animate-spin mx-auto",
    errorContainer: "text-center py-20 text-red-500 min-h-[300px]",
    propertiesGrid: "grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3",
    discoverButtonContainer: "text-center mt-20",
    discoverButton: "btn btn-primary py-4 px-12 rounded-3xl",
...
// sellerInquires.
export const sellerInquiriesStyles = {
    // ===== Container =====
    container: "p-4 md:p-6 lg:p-8",

    // ===== Header =====
    headerWrapper: "mb-6",
    headerFlex: "flex flex-col sm:flex-row sm:items-center justify-between gap-4",
    headerTitle: "text-2xl md:text-3xl font-bold text-gray-800",
    headerSubtitle: "text-gray-500 text-sm mt-1",
    newCountBadge: "bg-emerald-50 border border-emerald-200 rounded-lg px-4 py-2",
    newCountText: "text-emerald-700 font-medium",

    // ===== Filter Tabs =====
    filterContainer: "flex flex-wrap gap-2 mb-6",
    ...
    // ===== Empty State =====
    emptyState: "bg-white rounded-xl shadow-sm p-12 text-center border border-gray-100",
    emptyIcon: "text-gray-300 mx-auto mb-4",
    emptyTitle: "text-xl font-semibold text-gray-600 mb-2",
    emptyText: "text-gray-400",
    viewAllLink: "mt-4 text-emerald-600 hover:text-emerald-700 font-medium",

    // ===== Inquiry Card =====
    inquiryCard: (isNew) =>
        `bg-white rounded-xl shadow-sm border p-4 md:p-6 transition hover:shadow-md ${
        isNew ? "border-emerald-200 bg-emerald-50/30" : "border-gray-100"
      }`,
    inquiryFlex: "flex flex-col md:flex-row md:items-start justify-between gap-4",
    inquiryLeft: "flex-1",

    // ===== Property Info =====
    propertyInfo: "flex items-start gap-3",
    propertyIcon: "p-2 bg-emerald-50 rounded-lg",
    propertyIconSvg: "text-emerald-600",
    propertyTitle: "font-semibold text-gray-800",
    propertyLink: "text-xs text-emerald-600 hover:underline",

    // ===== Buyer Details =====
    buyerGrid: "mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3",
    buyerCard: "bg-gray-50 rounded-lg p-3",
    buyerLabel: "text-xs text-gray-400 uppercase tracking-wider flex items-center gap-1",
    buyerName: "font-medium text-gray-800",
    buyerEmail: "text-sm text-gray-500 flex items-center gap-1",
    buyerPhone: "text-sm text-gray-500 flex items-center gap-1",

    // ===== Received Date =====
    dateCard: "bg-gray-50 rounded-lg p-3",
    dateLabel: "text-xs text-gray-400 uppercase tracking-wider flex items-center gap-1",
    dateValue: "font-medium text-gray-800",
    timeValue: "text-sm text-gray-500",

    // ===== Message =====
    messageBox: "mt-4 bg-gray-50 rounded-lg p-4 border border-gray-100",
    messageText: "text-sm text-gray-600 italic",

    // ===== Right Side Actions =====
    actionsRight: "flex flex-col items-end gap-3 min-w-[120px]",
    statusBadge: (isRead) =>
    ...
    markReadButton: "flex items-center gap-1 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm rounded-lg transition",
    replyButton: "flex items-center gap-1 px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-600 text-sm rounded-lg transition",

    // ===== Loading =====
    loaderContainer: "flex items-center justify-center min-h-screen",
    loader: "w-12 h-12 border-4 border-emerald-500 border-t-transparent rounded-full animate-spin",

    // ===== Error =====
    errorContainer: "p-8 text-center text-[#dc2626]",
    errorTitle: "text-lg font-semibold",
    errorText: "text-sm",
    retryButton: "mt-4 px-6 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition",
};